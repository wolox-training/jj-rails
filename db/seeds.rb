...
if Rails.env.development?
    ...
    book = Book.create(gender: 'Detective fiction', author: 'Sir Arthur Conan Doyle', image: 'https://google.com.ar', title: 'A Study in Scarlet', editor: 'Ward Lock & Co', year: '1887')
